      ...
      <ScrollView style={styles.scroll}>
        ...
        <View style={styles.cardBox}>
          ...
          <View style={styles.card}>
            ...
            />
            <Text style={styles.cardTextName}> Anggur </Text>
